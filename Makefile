...
src/Error.o: src/Error.c
	$(CC) -Wall -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Error.o -c src/Error.c
...
src/utils.o: src/utils.c
	$(CC) -Wall -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/utils.o -c src/utils.c
...
plugins/persistence/nbt/cNBT/buffer.c: 

plugins/persistence/nbt/cNBT/buffer.h: 

plugins/persistence/nbt/cNBT/buffer.o: plugins/persistence/nbt/cNBT/buffer.c plugins/persistence/nbt/cNBT/buffer.h
	$(CC) -Wall -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -Iplugins/persistence/nbt -o plugins/persistence/nbt/cNBT/buffer.o -c plugins/persistence/nbt/cNBT/buffer.c

plugins/persistence.nbt.so: plugins/persistence/nbt/main.o plugins/persistence/nbt/src/nbt.o plugins/persistence/nbt/src/itoa.o plugins/persistence/nbt/cNBT/nbt_loading.o plugins/persistence/nbt/cNBT/nbt_parsing.o plugins/persistence/nbt/cNBT/nbt_treeops.o plugins/persistence/nbt/cNBT/nbt_util.o plugins/persistence/nbt/cNBT/buffer.o
	$(CC) -Wall -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) plugins/persistence/nbt/main.o plugins/persistence/nbt/src/nbt.o plugins/persistence/nbt/src/itoa.o plugins/persistence/nbt/cNBT/nbt_loading.o plugins/persistence/nbt/cNBT/nbt_parsing.o plugins/persistence/nbt/cNBT/nbt_treeops.o plugins/persistence/nbt/cNBT/nbt_util.o plugins/persistence/nbt/cNBT/buffer.o -shared -Wl,-soname,persistence.nbt.so -o plugins/persistence.nbt.so -lpthread -lz -ljansson -levent -levent_pthreads -lpcre -lltdl -export-dynamic $(LDFLAGS)
...
clean:
	...
	rm -rf plugins/persistence/nbt/cNBT/buffer.o
