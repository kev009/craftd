...
src/Set.o: src/Set.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Set.o -c src/Set.c

src/TimeLoop.c: 

src/TimeLoop.o: src/TimeLoop.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/TimeLoop.o -c src/TimeLoop.c

src/memory.c: 

src/memory.o: src/memory.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/memory.o -c src/memory.c

src/List.c: 

src/List.o: src/List.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/List.o -c src/List.c

src/Worker.c: 

src/Worker.o: src/Worker.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Worker.o -c src/Worker.c

src/Server.c: 

src/Server.o: src/Server.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Server.o -c src/Server.c

src/Plugin.c: 

src/Plugin.o: src/Plugin.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Plugin.o -c src/Plugin.c

src/ConsoleLogger.c: 

src/ConsoleLogger.o: src/ConsoleLogger.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/ConsoleLogger.o -c src/ConsoleLogger.c

src/Plugins.c: 

src/Plugins.o: src/Plugins.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Plugins.o -c src/Plugins.c

src/Console.c: 

src/Console.o: src/Console.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Console.o -c src/Console.c

src/Job.c: 

src/Job.o: src/Job.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Job.o -c src/Job.c

src/Event.c: 

src/Event.o: src/Event.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Event.o -c src/Event.c

src/Cache.c: 

src/Cache.o: src/Cache.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Cache.o -c src/Cache.c

src/Buffer.c: 

src/Buffer.o: src/Buffer.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Buffer.o -c src/Buffer.c

src/Buffers.c: 

src/Buffers.o: src/Buffers.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Buffers.o -c src/Buffers.c

src/Private.c: 

src/Private.o: src/Private.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Private.o -c src/Private.c

src/String.c: 

src/String.o: src/String.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/String.o -c src/String.c

src/Hash.c: 

src/Hash.o: src/Hash.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Hash.o -c src/Hash.c

src/craftd.c: 

src/craftd.o: src/craftd.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/craftd.o -c src/craftd.c

src/Logger.c: 

src/Logger.o: src/Logger.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Logger.o -c src/Logger.c

src/Client.c: 

src/Client.o: src/Client.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Client.o -c src/Client.c

src/Map.c: 

src/Map.o: src/Map.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Map.o -c src/Map.c

src/SystemLogger.c: 

src/SystemLogger.o: src/SystemLogger.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/SystemLogger.o -c src/SystemLogger.c

src/Regexp.c: 

src/Regexp.o: src/Regexp.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Regexp.o -c src/Regexp.c

src/Config.c: 

src/Config.o: src/Config.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Config.o -c src/Config.c

src/Workers.c: 

src/Workers.o: src/Workers.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o src/Workers.o -c src/Workers.c
...
third-party/bstring/bstrlib.o: third-party/bstring/bstrlib.c third-party/bstring/bstrlib.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o third-party/bstring/bstrlib.o -c third-party/bstring/bstrlib.c
...
third-party/bstring/bstraux.o: third-party/bstring/bstraux.c third-party/bstring/bstraux.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -o third-party/bstring/bstraux.o -c third-party/bstring/bstraux.c
...
plugins/persistence/nbt/main.o: plugins/persistence/nbt/main.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/persistence/nbt/main.o -c plugins/persistence/nbt/main.c
...
plugins/persistence/nbt/src/itoa.o: plugins/persistence/nbt/src/itoa.c plugins/persistence/nbt/include/itoa.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/persistence/nbt/src/itoa.o -c plugins/persistence/nbt/src/itoa.c
...
plugins/persistence/nbt/cNBT/nbt_parsing.o: plugins/persistence/nbt/cNBT/nbt_parsing.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/persistence/nbt/cNBT/nbt_parsing.o -c plugins/persistence/nbt/cNBT/nbt_parsing.c
...
plugins/persistence/nbt/cNBT/nbt_treeops.o: plugins/persistence/nbt/cNBT/nbt_treeops.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/persistence/nbt/cNBT/nbt_treeops.o -c plugins/persistence/nbt/cNBT/nbt_treeops.c

plugins/persistence/nbt/cNBT/nbt_util.c: 

plugins/persistence/nbt/cNBT/nbt_util.o: plugins/persistence/nbt/cNBT/nbt_util.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/persistence/nbt/cNBT/nbt_util.o -c plugins/persistence/nbt/cNBT/nbt_util.c
...
plugins/protocol/beta/main.o: plugins/protocol/beta/main.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/protocol/beta/main.o -c plugins/protocol/beta/main.c
...
plugins/protocol/beta/src/minecraft.o: plugins/protocol/beta/src/minecraft.c plugins/protocol/beta/include/minecraft.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/protocol/beta/src/minecraft.o -c plugins/protocol/beta/src/minecraft.c
...
plugins/protocol/beta/src/Buffer.o: plugins/protocol/beta/src/Buffer.c plugins/protocol/beta/include/Buffer.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/protocol/beta/src/Buffer.o -c plugins/protocol/beta/src/Buffer.c
...
plugins/protocol/beta/src/World.o: plugins/protocol/beta/src/World.c plugins/protocol/beta/include/World.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/protocol/beta/src/World.o -c plugins/protocol/beta/src/World.c
...
plugins/protocol/beta/src/PacketLength.o: plugins/protocol/beta/src/PacketLength.c plugins/protocol/beta/include/PacketLength.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/protocol/beta/src/PacketLength.o -c plugins/protocol/beta/src/PacketLength.c
...
plugins/protocol/beta/src/Packet.o: plugins/protocol/beta/src/Packet.c plugins/protocol/beta/include/Packet.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/protocol/beta/src/Packet.o -c plugins/protocol/beta/src/Packet.c
...
plugins/protocol/beta/src/Player.o: plugins/protocol/beta/src/Player.c plugins/protocol/beta/include/Player.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) -Iinclude -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/protocol/beta/src/Player.o -c plugins/protocol/beta/src/Player.c
...
plugins/tests/main.o: plugins/tests/main.c
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os -Wno-extra $(CFLAGS) -Iinclude -Iplugins/tests -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/tests/main.o -c plugins/tests/main.c
...
plugins/tests/tinytest/tinytest.o: plugins/tests/tinytest/tinytest.c plugins/tests/tinytest/tinytest.h
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os -Wno-extra $(CFLAGS) -Iinclude -Iplugins/tests -Iplugins/protocol/beta/include -Iplugins/persistence/nbt/include -Iplugins/mapgen/include -o plugins/tests/tinytest/tinytest.o -c plugins/tests/tinytest/tinytest.c

plugins/tests.so: plugins/tests/main.o plugins/tests/tinytest/tinytest.o
	$(CC) -Wall -Wextra -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) plugins/tests/main.o plugins/tests/tinytest/tinytest.o -shared -Wl,-soname,tests.so -o plugins/tests.so -export-dynamic $(LDFLAGS)

craftd_plugin_tests_build: plugins/tests.so

craftd_plugins: craftd_plugin_protocol_build craftd_plugin_persistence_build craftd_plugin_commands_build craftd_plugin_tests_build
