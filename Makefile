...
plugins/mapgen.classic.so: plugins/mapgen/classic/main.o plugins/mapgen/noise/simplexnoise1234.o
	$(CC) -Wall -Wno-unused -std=gnu99 -fPIC -DCRAFTD_VERSION='"0.1a"' -DNDEBUG -Os $(CFLAGS) plugins/mapgen/classic/main.o plugins/mapgen/noise/simplexnoise1234.o -shared -Wl,-soname,persistence.nbt.so -o plugins/mapgen.classic.so -export-dynamic $(LDFLAGS)
